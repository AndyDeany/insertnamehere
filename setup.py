...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = file_directory + "Python Files\insertnamehere.py"#!       # CHANGE THIS TO THE DIRECTORY OF THE PYTHON FILE YOU WANT TO MAKE INTO AN EXE FILE.
                                                                                # CHANGE THE 'cd' OF THE CMD PROMPT, WHICH YOU ARE RUNNING IN ADMINISTRATOR MODE, TO THE ^LOCATION^ OF THE PYTHON FILE. (this python file?)
        #Name of program                                                        # THEN TYPE 'python setup.py' or 'setup.py' INTO THE CMD PROMPT, WHILST IN THE DIRECTORY
        self.project_name = "insertnamehere"#!
        ...
        #Author of program
        self.author_name = "Andrew Dean"
        self.author_email = "oneandydean@hotmail.com"
        self.copyright = "Copyright (c) 2016 Me."#!
 
        #Description
        self.project_description = "Insert Name Here"#!
